...
function pay_mdl(crud,schema,url,assert,operation){
    console.log('pay model ready!');
        ...
        let operations = {
            ...
            'create': () =>{
                ...
                crud.Mongo_client(url, function (err,db) {
                    ...
                    crud.makeIndex(db,collection,{'pay.user_data': 'text'},function () {
