...
function confirm_mdl(crud,schema,url,assert,operation){
    console.log('confirm model ready!');
        ...
        let operations = {
            ...
            'create': () =>{
                ...
                crud.Mongo_client(url, function (err,db) {
                    ...
                    crud.makeIndex(db,collection,{'contact.user': 'text'},function () {
