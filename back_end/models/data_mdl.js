...
function data_mdl(crud,schema,url,assert,operation){
        ...
        let operations = {
            ...
            'create': () =>{
                ...
                crud.Mongo_client(url, function (err,db) {
                    ...
                    crud.makeIndex(db,collection,{'data_user.contact.email': 'text'},{ unique: true },function () {
